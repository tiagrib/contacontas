...
from gui.qml.ccqt import CCQT
from gui.qtMovementsTab import MovementsBackend
from gui.qml.matplotlib_item import MatplotlibItem
import sys
...
class ConCoWinQt():
	...
	def __init__(self, contacontas):
		...
		self.engine.addImportPath(str(Path("gui/qml/").resolve()))
		QtQml.qmlRegisterType(MatplotlibItem, 'Matplotlib', 1, 0, 'MatplotlibItem')
		self.engine.rootContext().setContextProperty("ccqt", self.ccqt)
